// let formTexts = document.querySelector(".formText");
// formTexts.addEventListener("click", () => {
//     // formTexts.setAttribute("style", "transition : 1s ease-in")
//     formTexts.setAttribute("style", "border: 1px solid black")
// })

// function newJobField() {
//     // e.preventDefault();
//     console.log("Adding New Field");
//     let newField = document.createElement("div")
//     // newField.classList.add("form-group")
//     newField.classList.add("formLabel")
//     // newField.classList.add("formText")
//     // newField.classList.add("job")


//     let jobObj = document.getElementById("job")
//     let jobAddButtonObj = document.getElementById("jobAddButton")

//     jobObj.insertBefore(newField, jobAddButtonObj)
// }
